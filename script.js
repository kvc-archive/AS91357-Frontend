...
<ul>
    ...
    <li><A href="achievement_units.html">AS Units</A></li>
...
var copyrightyear = "&copy Hy 2017 - " + new Date().getFullYear() + ` - <a href="/index.html" style="color: white">Modern Version</a></p>`;
